...
namespace AvtoSklad
{
    ...
    public partial class СкладКEntities : DbContext
    {
        public СкладКEntities()
            : base("name=СкладКEntities")
        {
        }
        ...
        public virtual DbSet<РезервТовара> РезервТовара { get; set; }
        public virtual DbSet<Товар> Товар { get; set; }
        public virtual DbSet<ЭлементЗаказа> ЭлементЗаказа { get; set; }
        public virtual DbSet<ЭлементИнвентаризации> ЭлементИнвентаризации { get; set; }
        public virtual DbSet<ЭлементПриходнойНакладной> ЭлементПриходнойНакладной { get; set; }
        public virtual DbSet<ЭлементРасходнойНакладной> ЭлементРасходнойНакладной { get; set; }
